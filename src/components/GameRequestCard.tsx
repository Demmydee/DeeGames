...
const GameRequestCard: React.FC<Props> = ({ request, onJoin }) => {
      ...
      <div className="flex -space-x-2 mb-6">
        {request.participants?.map((p) => (
          <div 
            ...
            className="w-8 h-8 rounded-full border-2 border-[#0a0a0a] bg-emerald-600 flex items-center justify-center text-[10px] font-bold text-white uppercase"
          >
