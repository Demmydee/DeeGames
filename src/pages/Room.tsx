      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500 uppercase tracking-widest">Active Requests</div>
          </div>
        </div>
        <div className="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500 uppercase tracking-widest">Live Matches</div>
          </div>
        </div>
        <div className="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center gap-4">
          ...
          <div>
            <div className="text-2xl font-black text-white">
              {room.is_free ? 'FREE' : `₦${room.min_wager.toLocaleString()}+`}
            </div>
            <div className="text-xs text-gray-500 uppercase tracking-widest">Entry Fee</div>
          </div>
        </div>
      </div>
