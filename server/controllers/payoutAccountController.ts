...
export const createPayoutAccount = async (req: any, res: Response) => {
  try {
    const account = await payoutAccountService.createPayoutAccount(req.user.id, req.body, req.token);
...
export const getPayoutAccounts = async (req: any, res: Response) => {
  try {
    const accounts = await payoutAccountService.getPayoutAccounts(req.user.id, req.token);
...
export const updatePayoutAccount = async (req: any, res: Response) => {
  try {
    const account = await payoutAccountService.updatePayoutAccount(req.user.id, req.params.id, req.body, req.token);
...
export const deletePayoutAccount = async (req: any, res: Response) => {
  try {
    await payoutAccountService.deletePayoutAccount(req.user.id, req.params.id, req.token);
